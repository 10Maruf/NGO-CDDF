...
@section('title') Career Opportunities - CDDF @endsection
...
{{-- ===== Hero Banner ===== --}}
<div class="hero-wrap" style="background-image: url('{{ (isset($application->career_hero_banner) && $application->career_hero_banner) ? asset('images/application/'.$application->career_hero_banner) : asset('static_image/news_event_blk.jpg') }}');
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center py-5">
                <p class="mb-2" style="font-size:.9rem;">
                    ...
                    <span style="color:#fff;">Get Involved</span>
                    <span class="mx-2" style="color:#ccc;">/</span>
                    <span style="color:#fff;">Career</span>
                </p>
                <h1 class="mb-0" style="color:#fff;font-weight:400;font-size:2.8rem;letter-spacing:1px;">Career Opportunities</h1>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <h2 style="font-weight:700;color:#1a1a1a;font-size:1.9rem;">Career Opportunities</h2>
            ...
            <div class="col-lg-4 col-md-6"
                ...
                <div class="pub-card">
                    ...
                    <div class="pub-card__img">
                        @php
                            $thumbRelPath = 'images/careers/thumbnails/'.$item->thumbnail;
                        ...
                        <div class="pub-card__actions">
                            ...
                            @if($item->pdf_file)
                                <a class="btn-download-pub"
                                   href="{{ asset('images/careers/pdfs/'.$item->pdf_file) }}"
        ...
        <div class="text-center py-5" data-aos="fade-up">
            <i class="fa-solid fa-briefcase fa-4x mb-3" style="color:#f86f2d;opacity:.25;"></i>
            <h5 style="color:#888;">No career opportunities available at the moment.</h5>

...
@section('title') Policy and Guideline - CDDF @endsection
...
{{-- ===== Hero Banner ===== --}}
<div class="hero-wrap" style="background-image: url('{{ (isset($application->policy_banner) && $application->policy_banner) ? asset('images/application/'.$application->policy_banner) : asset('static_image/news_event_blk.jpg') }}');
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center py-5">
                <p class="mb-2" style="font-size:.9rem;">
                    ...
                    <span class="mx-2" style="color:#ccc;">/</span>
                    <span style="color:#fff;">Policy and Guideline</span>
                </p>
                <h1 class="mb-0" style="color:#fff;font-weight:400;font-size:2.8rem;letter-spacing:1px;">Policy and Guideline</h1>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <h2 style="font-weight:700;color:#1a1a1a;font-size:1.9rem;">Policy and Guideline</h2>
        ...
        <div class="text-center py-5" data-aos="fade-up">
            ...
            <h5 style="color:#888;">No documents available at the moment.</h5>

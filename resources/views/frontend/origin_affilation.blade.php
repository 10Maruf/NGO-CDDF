...
{{-- ===== Hero Banner ===== --}}
<div class="hero-wrap" style="background-image: url('{{ (isset($application->origin_banner) && $application->origin_banner) ? asset('images/application/'.$application->origin_banner) : asset('static_image/news_event_blk.jpg') }}');
                ...
                <div class="pub-card">
                    ...
                    <div class="pub-card__img">
                        @php
                            ...
                            if (!empty($item->thumbnail) && !file_exists(public_path($thumbRelPath)) && file_exists(public_path('images/legal_affilation/'.$item->thumbnail))) {

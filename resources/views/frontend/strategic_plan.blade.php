...
@section('title') Strategic Plan - CDDF @endsection
...
{{-- ===== Hero Banner ===== --}}
<div class="hero-wrap" style="background-image: url('{{ (isset($application->strategic_plan_banner) && $application->strategic_plan_banner) ? asset('images/application/'.$application->strategic_plan_banner) : asset('static_image/news_event_blk.jpg') }}');
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center py-5">
                <p class="mb-2" style="font-size:.9rem;">
                    ...
                    <span class="mx-2" style="color:#ccc;">/</span>
                    <span style="color:#fff;">Strategic Plan</span>
                </p>
                <h1 class="mb-0" style="color:#fff;font-weight:400;font-size:2.8rem;letter-spacing:1px;">Strategic Plan</h1>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <h2 style="font-weight:700;color:#1a1a1a;font-size:1.9rem;">Strategic Plan</h2>
            <div class="mx-auto mt-2" style="width:50px;height:4px;background:#f86f2d;border-radius:2px;"></div>
        </div>

        @if(isset($strategicPlans) && count($strategicPlans) > 0)
        <div class="row g-4 justify-content-center">
            @foreach($strategicPlans as $item)
            <div class="col-lg-4 col-md-6"
                ...
                <div class="pub-card">
                    ...
                    <div class="pub-card__img">
                        @php
                            $thumbRelPath = 'images/strategic_plans/thumbnails/'.$item->thumbnail;
                        ...
                        <div class="pub-card__actions">
                            ...
                            @if($item->pdf_file)
                                <a class="btn-download-pub"
                                   href="{{ asset('images/strategic_plans/pdfs/'.$item->pdf_file) }}"
        ...
        <div class="text-center py-5" data-aos="fade-up">
            <i class="fa-solid fa-chess fa-4x mb-3" style="color:#f86f2d;opacity:.25;"></i>
            <h5 style="color:#888;">No strategic plans available at the moment.</h5>

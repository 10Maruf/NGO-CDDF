...
@section('title_l1', 'Edit Archived Project')
@section('bread_crumb')
    <li class="breadcrumb-item"><a href="{{ route('project.archive.index') }}">Project Archive</a></li>
                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('project.archive.update',$project->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12 d-flex align-items-center gap-2">
                            ...
                            <a href="{{ route('project.archive.index') }}" class="btn btn-danger px-4">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>

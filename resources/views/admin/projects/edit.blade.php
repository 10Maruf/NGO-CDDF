                    ...
                    <form class="row g-3" id="project_form"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="budget"
                                   value="{{ old('budget', $project->budget) }}" min="0" step="0.01"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="beneficiary_count"
                                   value="{{ old('beneficiary_count', $project->beneficiary_count) }}" min="0"
                        ...
                        <div class="col-md-12">
                            <label class="form-label fw-semibold">Implementing Partner</label>
                        ...
                        <div class="col-md-12">
                            <label class="form-label fw-semibold">
                                Donors / Partners
                                <small class="text-muted fw-normal">(multiple select)</small>
                            </label>
                            <div class="border rounded p-3" style="max-height:180px;overflow-y:auto;">
                                @forelse ($partners as $partner)
                                    @php $checked = in_array($partner->id, old('partner_ids', $selectedPartners)); @endphp
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="border rounded p-3" style="max-height:180px;overflow-y:auto;">
                                @forelse ($focus_areas as $area)
                                    @php $checked = in_array($area->id, old('focus_area_ids', $selectedFocusAreas)); @endphp
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox"
                                               name="focus_area_ids[]"
                                               value="{{ $area->id }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="is_active" class="form-select">
                                <option value="1" {{ old('is_active', $project->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $project->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var existingContent = {!! json_encode(old('detail_description', $project->detail_description ?? '')) !!};

...
@section('title_l1', 'Add Publication')
@section('bread_crumb')
                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('publications.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12 d-flex align-items-center gap-2">
                            <button class="btn btn-primary px-4" type="submit">Add Publication</button>
                            <a href="{{ route('publications.index') }}" class="btn btn-secondary px-4">Back to List</a>
                        </div>
                    </form>
                </div>
            </div>

...
@section('title_l1', 'Add Member')
@section('bread_crumb')
    <li class="breadcrumb-item"><a href="{{ route('executive.index') }}">Executive Committee</a></li>
                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('executive.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12 d-flex align-items-center gap-2">
                            ...
                            <a href="{{ route('executive.index') }}" class="btn btn-secondary px-4">Back to List</a>
                        </div>
                    </form>
                </div>
            </div>

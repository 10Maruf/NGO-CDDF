...
@section('title_l1', 'Add Legal Affiliation')
@section('bread_crumb')
...
<div class="row">
    <div class="col-xl-9 mx-auto">
        <h6 class="mb-0 text-uppercase">Add Origin and Legal Affiliation</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-4 border rounded">
                    <form class="row g-3" action="{{ route('origin.legal_affilation.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="text-info">Maximum size 2 MB. Supported formats: JPG, PNG, JPEG, GIF</span>
                            @error('thumbnail')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 d-flex align-items-center gap-2">
                            ...
                            <a href="{{ route('origin.legal_affilation.index') }}" class="btn btn-secondary px-4">Back to List</a>
                        </div>
                    </form>
                </div>
            </div>
